...
public struct RuntimeReflection {
    public static func getValueOf(
        property hierarchicalKeyPath: String, in object: Any, with pInfo: ParsedInfo
    ) -> Any? {
    ...
    public static func setValue(
        _ value: Any, forProperty hierarchicalKeyPath: String, in object: inout Any,
