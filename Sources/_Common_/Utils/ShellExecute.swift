...
import Foundation
    ...
    public enum Shell {
        public static func execute(command cmd: String, options: Options? = nil) -> Result {
            ...
            do {
                ...
                return Result(
                    failedToRun: true, error: "Process failed: \(error.localizedDescription)")
            }
        ...
        public struct Result {
            ...
            public init(
                failed: Bool = false, exitCode: Int32 = 0, stdout stdoutData: Data,
    ...
    public enum Shell {
        public static func execute(command cmd: String, options: Options? = nil) -> Result {
            return Result(
                failedToRun: true, error: "Shell commands are not supported on this platform.")
        }
        ...
        public struct Result {
            ...
            public init(
                failed: Bool = false, exitCode: Int32 = 0, stdout: String? = nil,
                stderr: String? = nil
            ) {
                self.failed = failed
                self.exitCode = exitCode
