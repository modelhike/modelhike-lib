...
public enum CommonRegEx {
    ...
    nonisolated(unsafe)
        public static let doubleLiteralPattern_Capturing: Regex<(Substring, Double?)> = Regex {
            Capture {
                doublePattern
            } transform: {
                Double($0)
    ...
    nonisolated(unsafe)
        public static let integerLiteralPattern_Capturing: Regex<(Substring, Int?)> = Regex {
            Capture {
                integerPattern
            } transform: {
                Int($0)
    ...
    nonisolated(unsafe)
        public static let numberLiteralPattern_Capturing: Regex<(Substring, Double??, Int??)> =
            Regex {
                ChoiceOf {
    ...
    nonisolated(unsafe)
        public static let stringLiteralPattern_Capturing: Regex<(Substring, String?, String?)> =
            Regex {
                ChoiceOf {
    ...
    nonisolated(unsafe)
        public static let functionInvocation_unNamedArgs_Capturing:
        Regex<(Substring, String, String)> = Regex {
            Capture {
                functionName
            } transform: {
                String($0)
    ...
    nonisolated(unsafe)
        public static let functionInvocation_namedArgs_Capturing:
        Regex<(Substring, String, String)> = Regex {
            Capture {
                functionName
            } transform: {
    ...
    nonisolated(unsafe)
        public static let functionDeclaration_unNamedArgs_Capturing:
        Regex<(Substring, String, String)> = functionInvocation_unNamedArgs_Capturing
    ...
    nonisolated(unsafe)
        public static let modifiersForExpression_Capturing: Regex<(Substring, String?)> = Regex {
            whitespace
            Optionally {
