...
public class OutputFolder : CustomDebugStringConvertible {
    ...
    public func add(_ doc: Document, renderConfig: RenderConfig) -> OutputDocumentFile {
    ...
    public func add(_ doc: Document, to fileSetName: String, renderConfig: RenderConfig) -> OutputDocumentFile {
