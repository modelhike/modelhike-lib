...
public class OutputFolder : CustomDebugStringConvertible {
    ...
    public func add(_ doc: RenderableDocument, renderConfig: RenderConfig) -> OutputDocumentFile {
        let filename = "file\(autoGeneratedFileNumber)"
        autoGeneratedFileNumber += 1
        return add(doc, filename: filename, renderConfig: renderConfig)
    }

    public func add(_ doc: RenderableDocument, filename: String, renderConfig: RenderConfig, type: OutputDocumentFile.InputFileType = .generic) -> OutputDocumentFile {
    ...
    public func add(_ doc: RenderableDocument, to fileSetName: String, renderConfig: RenderConfig) -> OutputDocumentFile {
        let folder = subFolder(fileSetName)
        return folder.add(doc, renderConfig: renderConfig)
    }

    public func add(_ doc: RenderableDocument, filename: String, to fileSetName: String, renderConfig: RenderConfig, type: OutputDocumentFile.InputFileType = .generic) -> OutputDocumentFile {
        let folder = subFolder(fileSetName)
