...
//
//source:  https://github.com/BinaryBirds/plural-kit/blob/main/Sources/PluralKit/PluralKit.swift
...
internal final class PluralKit {
    ...
    func apply(word: String) -> String {
        guard !(uncountables.contains(word.lowercased()) || word.count == 0) else {
            return word
        }
