...
public actor C4ComponentList: ArtifactHolder, _CollectionAsyncSequence {
    ...
    public func forEachType(
        by transform: @Sendable (inout CodeObject, inout C4Component) async throws -> Void
    ) async throws {
    ...
    public func forEach(by transform: @Sendable (inout C4Component) async throws -> Void)
        async throws
    {
