...
public typealias BeforeParseTemplateHandler = (_ templateName: String, _ ctx: GenerationContext) throws -> Void
public typealias BeforeExecuteTemplateHandler = (_ templateName: String, _ ctx: GenerationContext) throws -> Void
public typealias BeforeParseScriptFileHandler = (_ templateName: String, _ ctx: GenerationContext) throws -> Void
public typealias BeforeExecuteScriptFileHandler = (_ templateName: String, _ ctx: GenerationContext) throws -> Void
